...
class Book {
    ...
    identify = () => `${this.title}, ${this.author}, ${this.pubDate}`;
}
...
console.log(atomicHabits.identify());
*/
...
class Library {
    ...
    identify = () => `${this._name}, ${this._books}, ${this._deleteBook}`;
    ...
    //I am struggling to complete this part.
   deleteBook(isbn) {
       for (const deletebook of this._deleteBook) {
           const {isbn} = deletebook;
  ...
  class Book {
    ...
    identify = () => `${this.title}, ${this.author}, ${this.pubDate}, ${this.isbn}`;
}

  // Create library object
const library = new Library("New York Times Best Seller List");
console.log(library.identify());
